...
class example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Example", catch_exceptions=True)
        ...
        self._center_freq_range = qtgui.Range(100000, 5000000, 1000, 100000, 200)
        ...
        self.connect((self.soapy_hackrf_source_0, 0), (self.soapy_hackrf_sink_0, 0))
