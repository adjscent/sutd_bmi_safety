...
class example_10hz(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "elf", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "example_10hz")
        ...
        self.modulated_freq = modulated_freq = 300
        self.center_freq = center_freq = 928000000

        ##################################################
        # Blocks
        ##################################################

        self._modulated_freq_range = qtgui.Range(0, 3000, 50, 300, 200)
        self._modulated_freq_win = qtgui.RangeWidget(self._modulated_freq_range, self.set_modulated_freq, "'modulated_freq'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._modulated_freq_win)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SAW_WAVE, modulated_freq, 1, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_1.set_frequency_range(self.modulated_freq, self.samp_rate)
    ...
    def set_modulated_freq(self, modulated_freq):
        ...
        self.analog_sig_source_x_0.set_frequency(self.modulated_freq)
        self.qtgui_freq_sink_x_1.set_frequency_range(self.modulated_freq, self.samp_rate)
...
def main(top_block_cls=example_10hz, options=None):
