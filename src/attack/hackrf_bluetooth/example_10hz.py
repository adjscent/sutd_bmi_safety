...
class example_10hz(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.low_pass_filter_0, 0), (self.soapy_hackrf_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 4000000, 1000000, window.WIN_HAMMING, 6.76))
